...
*Disclaimer: this blog post is somewhat off topic in that it focuses on blogging more than backend software development. I think you will find this post informative if you have any interest in blogging, static site generation, or Go.*

This post starts with a full example of using Hugo to create a simple blog. It then compares alternative blogging frameworks like Jekyll and Wordpress.
...
Without further ado, let's jump into a real world example of using Hugo (my blog).

### Setting up a simple blog with Hugo

These steps will show how to make a simple blog generated with Hugo. Most of this content is adapted from [this tutorial](https://gohugo.io/hosting-and-deployment/hosting-on-github/).
...
GitHub is a great way to store the contents of your blog. Several of the guides I followed recommended that you make two repositories, one for the site and another for the generated site that will actually be hosted.
